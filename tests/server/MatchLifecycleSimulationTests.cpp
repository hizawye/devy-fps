...
TEST_CASE("Match lifecycle transitions pre-match to in-match to post-match on authoritative timer") {
  MatchLifecycleSimulation simulation({2U, 3U, 1U, 2U, 1U});
  ...
  REQUIRE(tick_1.state.remaining_seconds == 1U);
  ...
  REQUIRE(tick_2.state_changed);
  REQUIRE(tick_2.state.remaining_seconds == 3U);
  ...
  REQUIRE(tick_3.state.remaining_seconds == 2U);
  ...
  REQUIRE(tick_4.state.remaining_seconds == 1U);
  ...
  REQUIRE(tick_5.state_changed);
  REQUIRE(tick_5.state.remaining_seconds == 0U);
